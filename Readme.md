...
Когда нода выделена, имя сборки становится `#<номер> <нода>` (`#19 miha-home`): так агент виден в Stage View и
в списке сборок на странице задачи. Имя, заданное в Jenkinsfile до вызова `unityCi`, не трогается.
